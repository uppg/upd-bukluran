<div class="span-19 last" id="content_main">
	...
	<p>
	Currently adding entry to Disbursements of form 2 of organization <strong><?= $orgname ?></strong><br/>
	for application period <strong><?= $pretty_application_aysem ?></strong>
	</p>
	
	<?= form_open('organization/form2_add_disbursement_submit'.($this->session->user_group_is(OSA_GROUPID)?"/{$appsemid}/{$orgid}":'')) ?>
	<table>
	<tr>
