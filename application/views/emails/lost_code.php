...
You have clicked on the Lost Confirmation Code Link.You can login to Bukluran by going to:<?=br(2)?>


<a href="http://bukluran.osa.upd.edu.ph/index.php/login/link/<?=$user['hashcode']?>">http://bukluran.osa.upd.edu.ph/index.php/login/link/<?=$user['hashcode']?></a><?=br(2)?>

Your code for logging in is: <b><?= $user['hashcode']?></b><?=br(2)?>

This code serves as a password for your account, please refrain from sharing it to others.<?=br(2)?>

If haven't clicked on the Lost Confirmation Code Link, please ignore this message.<?=br(2)?>
