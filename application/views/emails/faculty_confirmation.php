...
The <?=$organization['orgname']?> has listed you as Faculty Adviser in their application for university recognition.<?=br(2)?>

You can confirm your membership to the organization by going to:<?=br(2)?>

<a href="http://bukluran.osa.upd.edu.ph/index.php/login/link/<?=$faculty['hashcode']?>">http://bukluran.osa.upd.edu.ph/index.php/login/link/<?=$faculty['hashcode']?></a><?=br(2)?>
